<script>
    ...
    async function handleClickRevealedButton(event) {
...
<div class="button-reveal-container">
    <button 
        ...
        <button tabindex="0" class="revealed-button flex-shrink-0 focus:outline-none" on:click={handleClickRevealedButton}>
